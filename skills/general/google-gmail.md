...
## Usage
```bash
python3 ~/.claude/tools/general/scripts/google_workspace.py gmail search --query "from:boss@example.com"
python3 ~/.claude/tools/general/scripts/google_workspace.py gmail draft --to x@y.com --subject "Hi" --body "Draft body"
```
