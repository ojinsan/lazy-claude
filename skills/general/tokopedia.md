...
## Usage
```bash
python3 ~/workspace/tools/general/browser/tokopedia_browser.py search --query "office chair"
python3 ~/workspace/tools/general/browser/tokopedia_browser.py compare --urls URL1 URL2
```
