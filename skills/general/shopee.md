...
## Usage
```bash
python3 ~/workspace/tools/general/browser/shopee_browser.py search --query "mechanical keyboard"
python3 ~/workspace/tools/general/browser/shopee_browser.py compare --urls URL1 URL2
```
